...
import { getConferences, deleteConferenceById } from 'apiSdk/conferences';
...
export function ConferenceListPage(props: ConferenceListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<ConferenceInterface>>(
    () => `/conferences?params=${JSON.stringify(params)}`,
    fetcher,
  );
