  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless communication with WeConnect, your ultimate solution for building engaging and effective video conferencing experiences."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1588196749597-9ff075ee6b5b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2aWRlbyUyMGNvbmZlcmVuY2luZ3xlbnwwfHx8fDE2OTQ3ODg1MzR8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless communication with WeConnect, your ultimate solution for building engaging and effective video conferencing experiences.`}
            </Text>
            <Box
